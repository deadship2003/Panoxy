# =====================================================================
# {{.Prog}} 基础配置 v0.2.0(Go 版,由 {{.Prog}} 渲染)
...
{{- if .TProxy}}
# ============ TPROXY 模式(mark/策略路由/劫持链由 {{.Prog}} 防火墙模块管理)============
...
# ============ 规则订阅 ============
rule-providers:
  # HyperADRules 广告/恶意域名聚合拦截 https://github.com/Lynricsy/HyperADRules
  # 源站发布在 GitHub Releases(国内直连不可达):离线包已预置同名缓存文件,
